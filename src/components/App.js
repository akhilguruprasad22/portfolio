        ...
        <div className="App">
          <VStack spacing={0}>
            ...
            <VStack className='main-heading'>
              <Text className='heading' as='b' fontSize='7xl' color='white'>{heading==='Nothing here.' ? <FontAwesomeIcon icon={faTriangleExclamation} size='xs'/> : <FontAwesomeIcon icon={faGhost} size='xs'/>} {heading}</Text>
            </VStack>
